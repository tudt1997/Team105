...
class car_control:
    ...
    def cal_steerAngle(self, img, sign):
        ...
        middle_pos = float(self.model.predict(img_bv[None, :, :, :], axis=0), batch_size=1) * 160 + 160
        ...
        cv2.line(img_bv, (middle_pos, self.h / 2), (self.w / 2, self.h), 255, 2, cv2.LINE_AA)
    ...
    def test(self, model):
        ...
        for img_path in glob.glob(path + '/test/*.jpg'):
            ...
            print(middle_pos, predicted_middle_pos)đc
